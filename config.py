...
SECTIONS = {
    'Steel': {
        # European wide-flange
        'IPE_300':  {'A': 8.34,  'Iy': 14.5,    'Iz': 201.0,   'J': 0.48},
        'HEA_200':  {'A': 8.35,  'Iy': 32.2,    'Iz': 88.7,    'J': 0.35},
        # AISC wide-flange
        'W8x31':    {'A': 9.13,  'Iy': 37.1,    'Iz': 110.0,   'J': 0.54},
        'W12x50':   {'A': 14.6,  'Iy': 56.3,    'Iz': 391.0,   'J': 1.04},
        'W12x53':   {'A': 15.6,  'Iy': 95.8,    'Iz': 425.0,   'J': 1.58},
        'W14x90':   {'A': 26.5,  'Iy': 362.0,   'Iz': 999.0,   'J': 4.06},
        'W14x159':  {'A': 46.7,  'Iy': 748.0,   'Iz': 1900.0,  'J': 14.5},
        'W14x283':  {'A': 83.3,  'Iy': 1070.0,  'Iz': 3840.0,  'J': 72.8},
        'W18x97':   {'A': 28.5,  'Iy': 201.0,   'Iz': 1750.0,  'J': 5.86},
        'W24x146':  {'A': 43.0,  'Iy': 391.0,   'Iz': 4580.0,  'J': 16.2},
        # HSS Round
        'HSS6x0.500':   {'A': 8.09,  'Iy': 24.7,  'Iz': 24.7,  'J': 49.4},
        'HSS10x0.500':  {'A': 14.0,  'Iy': 120.0, 'Iz': 120.0, 'J': 240.0},
        'HSS16x0.625':  {'A': 29.1,  'Iy': 670.0, 'Iz': 670.0, 'J': 1340.0},
        # HSS Square
        'Tubular_HSS_4x4x1/4': {'A': 3.37,  'Iy': 7.8,   'Iz': 7.8,   'J': 12.5},
        'HSS8x8x0.500':        {'A': 13.5,  'Iy': 105.0, 'Iz': 105.0, 'J': 169.0},
        'HSS12x12x0.625':      {'A': 26.9,  'Iy': 420.0, 'Iz': 420.0, 'J': 676.0},
        # Core
